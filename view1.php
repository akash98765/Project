...
$stmt="SELECT name,price,id,source,category,platform FROM games";
$stmt2="SELECT name,id,quote,rating FROM sellerg";
$stmt3="SELECT * FROM review";
$stmt4="SELECT name,id FROM sellerg";
...
<td>$priceq</td>
<td>$rating</td>
<td><a href='view1.php?name=$go&dis=$dis&id=$id&select=$seller' class='button'>";
